function pickFromStation(motor1,motor2,gripper,gripper_speed,height_sensor,station)
% pickFromStation Takes the station coordinates as argument and picks the ball from there
    ...
    pause(3);
    gripper_close(gripper,gripper_speed);
    pause(3);
